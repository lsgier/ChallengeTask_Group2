...
public class Run2 extends FuseFilesystemAdapterAssumeImplemented
{
    ...
    private final class MemoryFile extends MemoryPath
    {
        ...
        protected void getattr(final StatWrapper stat)
        {
            stat.setMode(NodeType.FILE).size(contents.capacity()).atime(12000);
        }
    ...
    public static void main(final String... args) throws FuseException
    {
        ...
        new Run2().log(true).mount(args[0]);
    }
